...
- **Functional Requirements**:
  ...
  - Action processing flow:
    ...
    - Server action uses AI SDK `streamText()` with OpenRouter provider (`qwen/qwen3-vl-8b-instruct`) and `maxSteps: 5` to allow multi-step reasoning (Reason -> Act -> Narrate)
