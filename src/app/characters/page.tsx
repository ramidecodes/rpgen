...
function CharacterCard({
  ...
  return (
    <div className="flex flex-col border rounded-lg bg-card hover:border-primary/50 transition-colors overflow-hidden group h-full shadow-sm hover:shadow-md relative">
      <Link
      ...
      >
        ...
        <div className="flex flex-col flex-1 p-3 space-y-2">
          ...
          {backstoryPreview && (
            <p className="text-xs text-foreground/75 line-clamp-1 leading-snug">
              {backstoryPreview}
            </p>
          )}
      ...
      <AlertDialog>
        <AlertDialogTrigger asChild>
          <Button
            variant="destructive"
            size="icon"
            className="absolute top-3 right-3 h-8 w-8 bg-background/20 backdrop-blur-md border-white/20 text-white hover:bg-destructive/90 hover:text-white cursor-pointer z-10"
            onClick={(e) => {
              e.stopPropagation();
            }}
            disabled={isDeleting}
        ...
        <AlertDialogContent onClick={(e) => e.stopPropagation()}>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              be undone. All associated runs and their messages will be
